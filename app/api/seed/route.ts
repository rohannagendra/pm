    ...
    const tasks = await Promise.all([
      prisma.task.create({
        data: {
          ...
          completedAt: new Date("2026-01-30T14:00:00.000Z"),
        },
      }),
      prisma.task.create({
        data: {
          ...
          dueDate: "2026-02-10",
          project: "proj-1",
          tags: JSON.stringify(["frontend", "auth"]),
      ...
      prisma.task.create({
        data: {
          ...
          dueDate: "2026-02-15",
          project: "proj-2",
          tags: JSON.stringify(["design", "mobile"]),
      ...
      prisma.task.create({
        data: {
          ...
          completedAt: new Date("2026-02-02T16:00:00.000Z"),
        },
      }),
    ]);
